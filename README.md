...
2. Paste the contents of `prompt.txt` (or `Agent Prompt.txt`)
...
2. Import all PDFs, documents, and verse files generated by the scraper
3. For multi-file sets (e.g., Academic Calendars), toggle **Group these files**
