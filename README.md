...
2. Paste the contents of `Agent Prompt.txt`
...
**Purpose:** The scraper collects accurate and vetted Bible verses from OpenGateway.com and combines them with response-keyword matching to provide users with biblical encouragement and guidance throughout conversations.
...
4. **If Python 3.12 is not installed:**
   ...
   **macOS Installation:**
   ...
   2. Click "Continue" through introduction and license agreements
...
3. Import all PDFs, documents, and verse files generated by the scraper
4. For multi-file sets (e.g., Academic Calendars), toggle Group these files
5. Add a description and instructions for each group to guide retrieval and ensure accurate responses
...
The evaluation CSV/JSON files include:
- Test prompts
- Expected Topic triggers
- Expected results or behaviors
- Edge cases
- Verse-matching scenarios
